  ...
  return (
    <div className="min-h-dvh bg-gray-100 dark:bg-gray-950 transition-colors">
      <div className="flex min-h-dvh w-full flex-col bg-gray-50 dark:bg-gray-900">
        <header className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-2 py-2 md:px-4 flex items-center justify-between gap-3 transition-colors">
          <div className="flex min-w-0 items-center gap-2">
            <span className="hidden md:inline text-sm font-medium text-gray-700 dark:text-gray-300">
              NCHU Study Assistant
            </span>
          </div>
          <nav className="flex flex-1 justify-center gap-1 md:gap-3">
            <NavLink
              to="/"
              end
              className={({ isActive }) =>
                `flex items-center gap-1.5 md:gap-2 px-3 py-2 rounded-lg text-xs md:text-sm transition-colors ${
                  isActive
